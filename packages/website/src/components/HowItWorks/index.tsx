  ...
  return (
    <section className={styles.section}>
      <div className="container">
        <h2 className="margin-bottom--lg text--center">How it works</h2>
      </div>
      <div className={styles.previewTable}>
        <div>
          <h3>1. Write Your Component</h3>
          <p>You will develop your code in the conventional way using types:</p>
        ...
        <div className="margin-bottom--lg">
          ...
          <p>
            ...
            <a href={useBaseUrl('/docs/getting-started/template')}>template</a>{' '}
          ...
          <p>
            Now just{' '}
            <a href={useBaseUrl('/docs/getting-started/introduction#usage')}>
